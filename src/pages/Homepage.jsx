      ...
      <section className="py-20 flex items-center justify-center">
        <div className="bg-white shadow-2xl rounded-xl max-w-2xl p-6 flex flex-col gap-4 ">
          ...
          <p className="text-lg text-gray-700">
            Worldwise is your ultimate resource for discovering detailed country
            information. Learn about every country’s history, landmarks,
            culture, economy, and more—all in one place!
          </p>
